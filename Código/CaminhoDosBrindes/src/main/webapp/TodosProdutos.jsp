<%-- 
    Document   : TodosProdutos
    Created on : 13/06/2018, 11:28:55
    Author     : Nome
--%>
...
<html>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="telaUS.jsp"><font color="yellow">Caminho dos Brindes</font></a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="telaUS.jsp"><font color="yellow">Home</font></a></li>
  ...
  <div class="row">
    ...
    <a href="VisualizaProduto?id=${produto.IDProduto}"/><button align="center" type="submit" class="btn btn-primary">Mostrar Produtos</button></a> </div>
